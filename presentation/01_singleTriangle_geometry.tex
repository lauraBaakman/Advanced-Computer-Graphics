...
\begin{frame}\frametitle{Geometry}
	...
	\note[item]{\textbf{[Laura]} Focus on getting the different control primitives.}
	\note[item]{\textbf{[Laura]} Note that we only have this input primite, without information about its neighbours.}
\end{frame}
