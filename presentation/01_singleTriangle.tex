...
\begin{frame}\frametitle{Overview}
	...
	\note[item]{\textbf{[Laura]} Why quadratic patch for normals, why cubic patch for geometry: We need at least cubic geometry and quadratic normals to capture inflections. There are no additional data to suggest higher degree patches.Simplicity v.s. modeling range} 
