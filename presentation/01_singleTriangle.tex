	...
	\begin{frame}\frametitle{Construction}
		...
		\begin{columns}
			\begin{column}{0.9\textwidth}
				\begin{center}
					% \only<1>{\includegraphics[width=\textwidth]{./img/1_single/recap_initialTriangle.png}}
					\only<1>{\includegraphics[width=\textwidth]{./img/1_single/recap_geometry.png}}
					% \only<3>{\includegraphics[width=\textwidth]{./img/1_single/recap_normals.png}}
					% \only<4>{\includegraphics[width=\textwidth]{./img/1_single/recap_result.png}}
					% \only<5>{\includegraphics[width=\textwidth]{./img/1_single/recap_quadraticVsCubicPatch.png}}
				\end{center}		
			\end{column}
		\end{columns}
	\end{frame}	
	...
	\begin{frame}\frametitle{Construction}
		...
		\begin{columns}
			\begin{column}{0.9\textwidth}
				\begin{center}
					% \only<1>{\includegraphics[width=\textwidth]{./img/1_single/recap_initialTriangle.png}}
					% \only<2>{\includegraphics[width=\textwidth]{./img/1_single/recap_geometry.png}}
					% \only<1>{\includegraphics[width=\textwidth]{./img/1_single/recap_normals.png}}
					\only<4>{\includegraphics[width=\textwidth]{./img/1_single/recap_result.png}}
					% \only<1>{\includegraphics[width=\textwidth]{./img/1_single/recap_quadraticVsCubicPatch.png}}
				\end{center}		
			\end{column}
		\end{columns}
	\end{frame}	
