...
\begin{frame}\frametitle{Overview}
	...
	\begin{columns}
		...
		\end{column}
	\end{columns}
	\note<1>{\textbf{[Laura]} Shading out of the scope of this presentation}
	\note<1>{\textbf{[Laura]} Why quadartic patch for normals, why cubic patch for geometry}
\end{frame}	
