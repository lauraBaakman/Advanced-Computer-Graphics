...
\textcite{vlachos2001curved} introduced curved point-normal triangles as a method to improve the visual appeal of triangular meshes in real-time entertainment. A major advantage of this technique at the time of introduction (\citeyear{vlachos2001curved}) is that it is a fast method to improve the visual quality of the rendered objects.
