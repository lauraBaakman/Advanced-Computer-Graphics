...
\label{sss:method:geometry:construction}
	...
	\begin{enumerate}[label=(\roman*)]
		...
		\item The center coefficient is moved to the average of the tangent coefficients plus $1/2$ times the distance it had to travel from its intermediate position, see \crefe{eq:method:center_coefficient}.
	\end{enumerate}
	%
	\begin{figure}
		\centering
