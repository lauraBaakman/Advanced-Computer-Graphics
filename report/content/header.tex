...
\teaser{
	...
	\includegraphics[width=0.3\linewidth]{content/img/header/Suzanne_wireframe.png}
	\includegraphics[width=0.3\linewidth]{content/img/header/Suzanne.png}
	\includegraphics[width=0.3\linewidth]{content/img/header/Suzanne_PN.png}
	\centering
