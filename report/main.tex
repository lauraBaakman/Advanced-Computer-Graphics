...
\newcommand{\crefs}[1]{Section~\ref{#1}}
\newcommand{\Crefs}[1]{Section~\ref{#1}}

\newcommand{\crefe}[1]{Equation~\ref{#1}}
\newcommand{\Crefe}[1]{Equation~\ref{#1}}
...
\todo[inline]{Gebruik afkrotingen en hoofdletters voor cref}
\todo[inline]{Macro voor equations en sections}
